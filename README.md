...
1.2 The Project	3
2. Concept	4
2.1 Idea, Rationale, and Audience	4
2.2 Project Aims and Differentiation	4
2.3 Social and Mobile Theory	4
3. Team	5
3.1 Team Members	5
3.2 Responsibilities	5
3.3 Key Roles	6
3.4 Decision Making	6
3.5 Conflict Resolution	6
4. Communication	7
4.1 Meetings and Communication	7
4.2 File Storage	7
5. Plan	8
5.1 Project Phases	8
5.1.1 Initiation Phase	8
5.1.2 Definition Phase	8
5.1.3 Design Phase	8
5.1.4 Development Phase	8
5.2 Key Deliverables	9
5.3 Resources	10
6. Tags	10
6.1 Key Concepts	10
6.2 Keywords	10
...
1.2 The Project
This project proposes an application operating in the social and mobile computing space to connect users with available storage space with those looking for specific parking solutions. Named Parkit, the application will draw inspiration from existing resource sharing mediums such as AirBnB (www.airbnb.com).
...
Whilst applications such as Kerb already exist, many fail to incorporate features found in other resource sharing applications. These features include:
...
Design Prototype Final Presentation
...
Access to Facebook (Communication)
Paper and pencil (draw mockups)
Access to internet to research the other applications on the market
Access to a smartphone to test mobile implementation
6. Tags
6.1 Key Concepts
